  ...
  if(isLoading) {
    ...
    return (
        <div className="min-h-screen bg-base-300 flex items-center justify-center p-4">
            <div className="max-w-3xl w-full bg-base-100 shadow-lg rounded-xl p-6 py-10 flex flex-col md:flex-row gap-6">
                {/* Profile Image */}
                ...
                <div className="flex-1 flex flex-col justify-center gap-3">
                    <h2 className="text-2xl font-bold">{employeeData?.name || "John Doe"}</h2>
