...
const services = [
  ...
  },
  {
    ...
    icon: <FaShieldAlt className="text-3xl text-error" />,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, index) => (
            <motion.div
              key={index}
              className="bg-base-100 p-6 rounded-xl shadow hover:shadow-md transition-transform duration-300 hover:scale-[1.03]"
              initial="offscreen"
