  ...
  return (
    <footer className="bg-base-100 text-base-content pt-10 border-t border-gray-500">
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <h2 className="text-xl font-bold text-primary mozilla">TrackForce</h2>
        ...
        <div>
          <h3 className="text-lg font-semibold mb-2 mozilla text-primary">Quick Links</h3>
        ...
        <div>
          <h3 className="text-lg font-semibold mb-2 mozilla text-primary">Contact</h3>
          <p className="text-sm">Email: dev.rakibhasan1@gmail.com</p>
